...
const FS_DOCUMENT_DIR =
  Reflect.get(FileSystem, 'documentDirectory') ||
  Reflect.get(Reflect.get(FileSystem, 'Paths') || {}, 'document')?.uri ||
  '';
const FS_BASE64_ENCODING =
  Reflect.get(Reflect.get(FileSystem, 'EncodingType') || {}, 'Base64') || 'base64';
